              ...
              itemBuilder: (_, index) {
                return NeumorphicButton(
                    ...
                    onPressed: () {
                      ...
                      } else if (snapshot.data[index] == 1) {
                        return Navigator.pushNamed(context, PhraseViewRoute,
                            arguments: menuCategories[index].routeName);

                      } else if (snapshot.data[index] == 9) { 
                         if (secondMenuCategories[index].routeName == "youtuber" ) {
                           return Navigator.pushNamed(context, youtubeViewRoute,
                            arguments: youtubeMenuCategories[index-9].routeName);
                         } 
